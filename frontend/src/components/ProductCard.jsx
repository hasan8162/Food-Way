                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div className="text-primary">
                        {!cartItems[product._id] ? (
                            <button className="flex items-center justify-center gap-1 bg-primary/10 border border-primary/40 md:w-[80px] w-[64px] h-[34px] rounded text-primary font-medium cursor-pointer" onClick={(e) => {e.stopPropagation(); addToCart(product._id)}} >
